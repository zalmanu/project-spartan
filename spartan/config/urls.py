...
urlpatterns += [
    ...
    url(r'^faq/', login_required(TemplateView.as_view(template_name="faq/faq.html"))),
    url(r'^about/', login_required(TemplateView.as_view(template_name="about_us/about_us.html"))),
